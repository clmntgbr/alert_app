...
class DashboardScreenState extends State<DashboardScreen> {
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    width: 4,
                                    color: remainingPlacesColor.withOpacity(0.2),
                                  ),
                                ),
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                            ...
                            Padding(
                              ...
                              child: CustomPaint(
                                painter: CurvePainter(
                                    colors: [remainingPlacesColor, HexColor("#8A98E8"), HexColor("#8A98E8")], angle: (remainingPlaces / 100) * 60),
  ...
  Color getStoreColor(int remainingPlaces) {
    if (remainingPlaces >= 75 && remainingPlaces <= 95) {
      return Colors.orange;
    }

    if (remainingPlaces > 95) {
      return Colors.red;
    }
